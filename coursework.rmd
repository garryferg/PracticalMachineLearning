...
I then constructed a "formua" object using the variables left in columnsToUse, i.e. the variables that will be included in the model.
...
Initially I selected the "random forest" method as a good general purpose method. As it turned out, this method gave a good enough accuracy do I did not need to try any other method.
